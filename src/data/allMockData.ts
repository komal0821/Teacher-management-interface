...
export const mockTeacherMeetings: TeacherMeeting[] = [
  {
    ...
    description: 'Review of teaching performance and student feedback for Q1',
    date: '2024-02-15',
    time: '14:00',
    duration: 60,
  ...
  },
  {
    ...
    description: 'Planning budget allocation for Physics department equipment',
    date: '2024-02-20',
    time: '10:00',
    duration: 90,
...
export const mockTeacherLeaves: TeacherLeave[] = [
  {
    ...
    approvedDate: '2024-02-11T09:00:00Z',
    substituteTeacher: 'Ms. Jane Smith'
  },
  {
    id: '2',
    teacherId: '2',
